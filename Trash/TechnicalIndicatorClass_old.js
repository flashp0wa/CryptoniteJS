  ...
  */
  ...
  async handleKline(klineObj) {
    try {
      ...
      if (this.symbolData.has(res.symbolId)) {
        const timeFrame = this.symbolData.get(res.symbolId);
        timeFrame.set(res.timeFrameId, new Map(Object.entries(res)));
        this.symbolData.set(res.symbolId, timeFrame);
      } else {
